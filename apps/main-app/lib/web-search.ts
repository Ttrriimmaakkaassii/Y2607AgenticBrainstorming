...
// (functions/api/research/search.ts) — SEARCH (discovery: query in,
// candidate URLs/snippets out), via Tavily. Pairs with lib/web-browse.ts
// (Cloudflare Browser Rendering), which does the opposite job — full
// content of one already-known URL. This file keeps its own copy of the
